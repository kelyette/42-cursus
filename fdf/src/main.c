...
/*   Updated: 2024/12/19 15:54:34 by kcsajka          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	env.hmap->scale = (t_vec3){40, 20, 5};
	env.hmap->pos = (t_vec3){0, 0, 0};
	env.hmap->origin = (t_vec3){0.5, 0.5, 0};
	env.hmap->offset = (t_vec2){635, 360};
	init_mlx(&env);
	init_prefs(&env);
	init_drawers(&env);
	init_hooks(&env);
